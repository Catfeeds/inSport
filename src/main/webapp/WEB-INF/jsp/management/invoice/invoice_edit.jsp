				...
				<div class="row">
					...
					<form action="invoice/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">CONTRACT_ID:</td>
								<td><input type="text" name="CONTRACT_ID" id="CONTRACT_ID" value="${pd.CONTRACT_ID}" maxlength="255" placeholder="这里输入CONTRACT_ID" title="CONTRACT_ID" style="width:98%;"/></td>
							</tr>
							<tr>
