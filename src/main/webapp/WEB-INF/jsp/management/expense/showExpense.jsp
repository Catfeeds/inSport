					...
					<div class="col-xs-12">
						...
						<table class="table table-border table-bg table-bordered">
							...
							<tr class="success">
								...
								<th colspan="6">${utiPd.STARTTIME} 至
									${utiPd.ENDTIME}
								</th>
							</tr>
							<tr class="success">
								<th class="center"><label>付款方名称(水电费)：</label></th>
								<th class="center"><c:if test="${utiPd.PAYERNAME == ''||utiPd.PAYERNAME ==  null}">
									${conPd.CONTRACTOFNAME}
								</c:if>
							...
							<tr class="success">
								...
								<th  class="center">${utiPd.INVOICENAME}</th>

								<th class="center"><label>开票时间：</label></th>
								<th class="center">${utiPd.INVOICETIME}</th>
								<th class="center"></th>
								<th class="center"></th>
								<th class="center">
