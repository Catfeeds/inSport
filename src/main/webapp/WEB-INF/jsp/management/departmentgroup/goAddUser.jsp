					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<form action="departmentgroup/save.do" name="Form" id="Form"
								...
								<form action="departmentgroup/listDept.do" method="post" name="Form" id="search">
									<table style="margin-top:5px;">
										<tr>
											<td>
												<div class="nav-search">
										<span class="input-icon">
											<input style="width: 150px" type="text" placeholder="这里输入关键词" class="nav-search-input" id="nav-search-input"
