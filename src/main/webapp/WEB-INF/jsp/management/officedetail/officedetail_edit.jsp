		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="officedetail/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="OFFICEDETAIL_ID" id="OFFICEDETAIL_ID" value="${pd.OFFICEDETAIL_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="OFFICEPRIMARY_ID" id="OFFICEPRIMARY_ID" value="${pd.OFFICEPRIMARY_ID}" maxlength="255" placeholder="这里输入主表Id" title="主表Id" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function save(){
			...
			if($("#OFFICEPRIMARY_ID").val()==""){
				$("#OFFICEPRIMARY_ID").tips({
					side:3,
		            msg:'请输入主表Id',
		            bg:'#AE81FF',
		            time:2
		        });
				$("#OFFICEPRIMARY_ID").focus();
			return false;
			}
			$("#Form").submit();
			$("#zhongxin").hide();
