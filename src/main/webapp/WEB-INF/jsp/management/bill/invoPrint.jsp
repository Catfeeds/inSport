					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row"  style="margin-right: 5%;margin-left: 5%">
								...
								<p align="left" style="font-size: 18.7px;font-family: FangSong;line-height:27px;;text-indent:2em">
								...
								<p align="left" style="font-size: 18.7px;font-family: FangSong;line-height:27px;;text-indent:2em">
									...
									<fmt:formatDate value="${i}" pattern="yyyy年MM月dd日" var="time"/>
									<c:out value="${time}" escapeXml="false" />期间的租金和管理费${findInv.RECEIVABLE}元
									。贵司拖欠付款的行为已构成违约，根据合同第     条的约定，
									贵司应按         的标准向我司支付违约金，暂计至   年   月  日的违约金为人民币${findInv.OVERDUENUM}元。
								</p>
								<p align="left" style="font-size: 18.7px;font-family: FangSong;line-height:27px;;text-indent:2em">
									请贵司本着诚信原则，全面履行合同约定，在${pd.dateString3}前付清上述欠费及违约金共${findInv.SUM_N}元；
								...
								<div align="right" style="margin-right: 100px">
									<p  style="font-size: 18.7px;font-family: FangSong;line-height:27px;">佛山中奥广场管理有限公司</p>
									<p  id="FCREATETIME" style="margin-right:30px;font-size: 18.7px;font-family: FangSong;line-height:27px;">${pd.dateString}</p>
								</div>
								<hr>
								<!-- /.col -->
							</div>
