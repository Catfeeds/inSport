            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <!-- 检索  -->
                        <form action="reports/listOtherNotProceeds.do?CONTRACTNUM=${pd.CONTRACTNUM}" method="post" name="Form" id="Form">
                            ...
                            <%--<table id="simple-table" class="table table-striped table-bordered table-hover"
                                ...
                                <tr>
                                    ...
                                    <th class="center">应收金额
                                    </th>
                                    <th class="center">应收时间
                                    </th>
...
<script type="text/javascript">
    ...
    function toExcel() {
        ...
        window.location.href = '<%=basePath%>toexcel/excel_otherProceeds.do?picStart='+picStart+'&picEnd='+picEnd+'&YEAR='+YEAR+'&DEPTNAME='+DEPTNAME+
