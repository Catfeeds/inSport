            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <!-- 检索  -->
                        <form action="reports/listOtherNotProceeds.do?keywords=${pd.keywords}" method="post" name="Form" id="Form">
...
<script type="text/javascript">
    ...
    //导出excel
    function toExcel() {
        window.location.href = '<%=basePath%>toexcel/excel_otherProceeds.do';
    }
</script>
