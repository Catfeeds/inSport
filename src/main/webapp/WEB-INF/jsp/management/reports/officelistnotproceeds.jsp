            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <!-- 检索  -->
                        <form action="reports/officelistNotProceeds.do?CONTRACTNUM=${pd.CONTRACTNUM}" method="post" name="Form" id="Form">
                                ...
                                <div class="sti-tbl-header" style="padding-right:17px;">
                                    <table class="table table-bordered" style="margin-bottom: 0px;border-bottom-style: none;">
                                        <tr style="background-color: #99CCCC">
                                            ...
                                            <th style="width:10%;" class="center">应收合计
                                            </th>
...
<script type="text/javascript">
    ...
    function toExcel() {
        ...
        window.location.href = '<%=basePath%>toexcel/excel_officeNotProceeds.do?TYPE='+TYPE+'&picStart='+picStart+
                '&picEnd='+picEnd+'&YEAR='+YEAR+'&DEPTNAME='+DEPTNAME+'&CONTRACTNUM='+CONTRACTNUM;
    }
</script>
